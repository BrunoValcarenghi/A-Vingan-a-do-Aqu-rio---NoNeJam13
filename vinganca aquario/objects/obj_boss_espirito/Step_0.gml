 if place_meeting(x, y, obj_player_col) and ativo{
	...
	if d and !instance_exists(obj_dialogo) and global.flag_rato{
		ativo = false
	...
	if d and !instance_exists(obj_dialogo) and !global.flag_rato{
		ativo = false
		global.Juquinha.hp /=2
		if global.Juquinha.vida > global.Juquinha.hp global.Juquinha.vida = global.Juquinha.hp
		instance_destroy()
	}
